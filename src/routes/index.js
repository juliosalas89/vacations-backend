...
import { isValidDate } from "../validators/customValidators";
...
export default (config) => {
    ...
    [
        ...
        check('dateStart').notEmpty(),
        check('dateEnd').notEmpty(),
        check('rating').notEmpty(),
        check('allInclusive').notEmpty()
    ],
    ...
    [
        ...
        check('rating').optional().notEmpty(),
